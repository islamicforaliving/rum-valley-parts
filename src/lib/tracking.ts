// Form tracking helper for Rum Valley lead forms.
// Wired to the connected CRM tracking integration. Fire-and-forget.
...
export const TRACKING_CONFIG = {
  trackingId: "tk_4273dabd60294260ba2f390aa117b32e",
  locationId: "A7magVKu7lKruPcwIcLY",
  projectId: "1787789511637791997",
};
...
export function buildTrackingPayload(formId: string, formName: string) {
  return {
    type: "external_form_submission",
    timestamp: Date.now(),
    formId,
    formData: {} as Record<string, unknown>,
    formLabels: {} as Record<string, string>,
    url: window.location.href,
    title: document.title,
    path: window.location.pathname,
    userAgent: navigator.userAgent,
    trackingId: TRACKING_CONFIG.trackingId,
    locationId: TRACKING_CONFIG.locationId,
    projectId: TRACKING_CONFIG.projectId,
